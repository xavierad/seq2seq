...
class Encoder(nn.Module):
    def __init__(self, input_size, embedding_size, hidden_size, num_layers, dropout) -> None:
...
class Decoder(nn.Module):
    def __init__(self, input_size, embedding_size, hidden_size, output_size, num_layers, dropout) -> None:
...
for epoch in range(num_epochs):
    ...
    for batch_dx, batch in enumerate(train_iterator):
